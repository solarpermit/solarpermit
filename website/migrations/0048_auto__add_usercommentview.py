...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserCommentView'
        db.create_table('website_usercommentview', (
            ...
            ('last_comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Comment'], null=True, blank=True)),
            ('comments_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('view_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('website', ['UserCommentView'])


    def backwards(self, orm):
        # Deleting model 'UserCommentView'
        db.delete_table('website_usercommentview')
