...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ViewQuestions'
        db.create_table('website_viewquestions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('view', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.View'])),
        ...
        db.send_create_signal('website', ['ViewQuestions'])


    def backwards(self, orm):
        # Deleting model 'ViewQuestions'
        db.delete_table('website_viewquestions')
