...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('website_usersearch', (
            ...
            ('search_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ))
        db.send_create_signal('website', ['UserSearch'])


    def backwards(self, orm):
        # Deleting model 'UserSearch'
        db.delete_table('website_usersearch')
