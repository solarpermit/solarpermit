...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('website_jurisdiction', 'parent_id')

        # Adding field 'Question.template'
        db.add_column('website_question', 'template',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.validation_class'
        db.add_column('website_question', 'validation_class',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.js'
        db.add_column('website_question', 'js',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.field_attributes'
        db.add_column('website_question', 'field_attributes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.terminology'
        db.add_column('website_question', 'terminology',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('website_jurisdiction', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_jurisdiction', null=True, to=orm['website.Jurisdiction'], blank=True),
                      keep_default=False)

        # Deleting field 'Question.template'
        db.delete_column('website_question', 'template')

        # Deleting field 'Question.validation_class'
        db.delete_column('website_question', 'validation_class')

        # Deleting field 'Question.js'
        db.delete_column('website_question', 'js')

        # Deleting field 'Question.field_attributes'
        db.delete_column('website_question', 'field_attributes')

        # Deleting field 'Question.terminology'
        db.delete_column('website_question', 'terminology')
