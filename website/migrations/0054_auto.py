...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Question', fields ['accepted']
        db.create_index('website_question', ['accepted'])


    def backwards(self, orm):
        # Removing index on 'Question', fields ['accepted']
        db.delete_index('website_question', ['accepted'])
