...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AnswerReference.reviewed'
        db.delete_column('website_answerreference', 'reviewed')

        # Deleting field 'AnswerReference.accepted'
        db.delete_column('website_answerreference', 'accepted')

        # Adding field 'AnswerReference.rating_status'
        db.add_column('website_answerreference', 'rating_status',
                      self.gf('django.db.models.fields.CharField')(default='U', max_length=8, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'AnswerReference.approval_status'
        db.add_column('website_answerreference', 'approval_status',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=8, db_index=True, blank=True),
                      keep_default=False)

        # Deleting field 'Comment.reviewed'
        db.delete_column('website_comment', 'reviewed')

        # Deleting field 'Comment.removed'
        db.delete_column('website_comment', 'removed')

        # Adding field 'Comment.rating_status'
        db.add_column('website_comment', 'rating_status',
                      self.gf('django.db.models.fields.CharField')(default='U', max_length=8, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Comment.approval_status'
        db.add_column('website_comment', 'approval_status',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=8, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AnswerReference.reviewed'
        db.add_column('website_answerreference', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AnswerReference.accepted'
        db.add_column('website_answerreference', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AnswerReference.rating_status'
        db.delete_column('website_answerreference', 'rating_status')

        # Deleting field 'AnswerReference.approval_status'
        db.delete_column('website_answerreference', 'approval_status')

        # Adding field 'Comment.reviewed'
        db.add_column('website_comment', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Comment.removed'
        db.add_column('website_comment', 'removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Comment.rating_status'
        db.delete_column('website_comment', 'rating_status')

        # Deleting field 'Comment.approval_status'
        db.delete_column('website_comment', 'approval_status')
