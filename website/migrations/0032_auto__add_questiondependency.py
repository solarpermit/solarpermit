...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('website_questiondependency', (
            ...
            ('answer_choice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.AnswerChoice'], null=True, blank=True)),
    ...
    models = {
        ...
        'website.questiondependency': {
            ...
            'answer_choice': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['website.AnswerChoice']", 'null': 'True', 'blank': 'True'}),
