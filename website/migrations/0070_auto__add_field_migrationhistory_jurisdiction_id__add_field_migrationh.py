...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MigrationHistory.jurisdiction_id'
        db.add_column('website_migrationhistory', 'jurisdiction_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MigrationHistory.notes2'
        db.add_column('website_migrationhistory', 'notes2',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MigrationHistory.jurisdiction_id'
        db.delete_column('website_migrationhistory', 'jurisdiction_id')

        # Deleting field 'MigrationHistory.notes2'
        db.delete_column('website_migrationhistory', 'notes2')
