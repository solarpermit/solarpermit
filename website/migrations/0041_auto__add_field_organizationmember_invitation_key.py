...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationMember.invitation_key'
        db.add_column('website_organizationmember', 'invitation_key',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationMember.invitation_key'
        db.delete_column('website_organizationmember', 'invitation_key')
