...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserPageView.view_datetime'
        db.delete_column('website_userpageview', 'view_datetime')

        # Adding field 'UserPageView.last_page_view_date'
        db.add_column('website_userpageview', 'last_page_view_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserPageView.view_datetime'
        db.add_column('website_userpageview', 'view_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserPageView.last_page_view_date'
        db.delete_column('website_userpageview', 'last_page_view_date')
