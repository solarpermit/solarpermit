...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserDetail.reset_password_key'
        db.add_column('website_userdetail', 'reset_password_key',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserDetail.reset_password_key'
        db.delete_column('website_userdetail', 'reset_password_key')
