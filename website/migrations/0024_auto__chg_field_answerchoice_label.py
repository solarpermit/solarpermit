...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnswerChoice.label'
        db.alter_column('website_answerchoice', 'label', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'AnswerChoice.label'
        db.alter_column('website_answerchoice', 'label', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
