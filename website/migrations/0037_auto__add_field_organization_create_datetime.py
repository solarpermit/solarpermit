...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.create_datetime'
        db.add_column('website_organization', 'create_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.create_datetime'
        db.delete_column('website_organization', 'create_datetime')
