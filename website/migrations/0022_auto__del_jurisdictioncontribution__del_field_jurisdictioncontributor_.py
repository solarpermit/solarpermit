...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'JurisdictionContributor.rank'
        db.delete_column('website_jurisdictioncontributor', 'rank')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'JurisdictionContributor.rank'
        db.add_column('website_jurisdictioncontributor', 'rank',
