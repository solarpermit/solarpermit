...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jurisdiction.name_for_url'
        db.add_column('website_jurisdiction', 'name_for_url',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jurisdiction.name_for_url'
        db.delete_column('website_jurisdiction', 'name_for_url')
