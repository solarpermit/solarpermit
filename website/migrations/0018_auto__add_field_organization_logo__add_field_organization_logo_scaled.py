...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_organization', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.logo_scaled'
        db.add_column('website_organization', 'logo_scaled',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('website_organization', 'logo')

        # Deleting field 'Organization.logo_scaled'
        db.delete_column('website_organization', 'logo_scaled')
