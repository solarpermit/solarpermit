...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.template_type'
        db.alter_column('website_template', 'template_type', self.gf('django.db.models.fields.CharField')(max_length=8))

    def backwards(self, orm):

        # Changing field 'Template.template_type'
        db.alter_column('website_template', 'template_type', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
