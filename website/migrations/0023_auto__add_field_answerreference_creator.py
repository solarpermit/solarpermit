...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerReference.creator'
        db.add_column('website_answerreference', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerReference.creator'
        db.delete_column('website_answerreference', 'creator_id')
