...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_comment', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding index on 'Comment', fields ['entity_id']
        db.create_index('website_comment', ['entity_id'])


    def backwards(self, orm):
        # Removing index on 'Comment', fields ['entity_id']
        db.delete_index('website_comment', ['entity_id'])

        # Deleting field 'Comment.rating'
        db.delete_column('website_comment', 'rating')
