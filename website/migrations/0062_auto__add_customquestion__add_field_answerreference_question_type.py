...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomQuestion'
        db.create_table('website_customquestion', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.QuestionCategory'], null=True, blank=True)),
            ('applicability', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Applicability'], null=True, blank=True)),
            ...
            ('validation_class', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('js', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('field_attributes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('terminology', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('has_multivalues', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('qtemplate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Template'], null=True)),
        ))
        db.send_create_signal('website', ['CustomQuestion'])

        # Adding field 'AnswerReference.question_type'
        db.add_column('website_answerreference', 'question_type',
                      self.gf('django.db.models.fields.CharField')(default='predefined', max_length=16, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CustomQuestion'
        db.delete_table('website_customquestion')

        # Deleting field 'AnswerReference.question_type'
        db.delete_column('website_answerreference', 'question_type')
    ...
    models = {
        ...
        'website.answerreference': {
            ...
            'question_type': ('django.db.models.fields.CharField', [], {'default': "'predefined'", 'max_length': '16', 'db_index': 'True'}),
        ...
        'website.customquestion': {
            'Meta': {'object_name': 'CustomQuestion'},
