...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JurisdictionRating'
        db.create_table('website_jurisdictionrating', (
        ...
        db.send_create_signal('website', ['JurisdictionRating'])


    def backwards(self, orm):
        # Deleting model 'JurisdictionRating'
        db.delete_table('website_jurisdictionrating')
