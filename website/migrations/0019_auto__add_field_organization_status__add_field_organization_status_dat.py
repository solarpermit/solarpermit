...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_organization', 'status',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=8, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.status_datetime'
        db.add_column('website_organization', 'status_datetime',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('website_organization', 'status')

        # Deleting field 'Organization.status_datetime'
        db.delete_column('website_organization', 'status_datetime')
