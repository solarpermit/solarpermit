...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.has_multivalues'
        db.add_column('website_question', 'has_multivalues',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.has_multivalues'
        db.delete_column('website_question', 'has_multivalues')
