...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.jurisdiction'
        db.add_column('website_action', 'jurisdiction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Jurisdiction'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Action.question_category'
        db.add_column('website_action', 'question_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.QuestionCategory'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReactionCategory.points'
        db.add_column('website_reactioncategory', 'points',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reaction.jurisdiction'
        db.add_column('website_reaction', 'jurisdiction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Jurisdiction'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reaction.question_category'
        db.add_column('website_reaction', 'question_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.QuestionCategory'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionCategory.points'
        db.add_column('website_actioncategory', 'points',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.jurisdiction'
        db.delete_column('website_action', 'jurisdiction_id')

        # Deleting field 'Action.question_category'
        db.delete_column('website_action', 'question_category_id')

        # Deleting field 'ReactionCategory.points'
        db.delete_column('website_reactioncategory', 'points')

        # Deleting field 'Reaction.jurisdiction'
        db.delete_column('website_reaction', 'jurisdiction_id')

        # Deleting field 'Reaction.question_category'
        db.delete_column('website_reaction', 'question_category_id')

        # Deleting field 'ActionCategory.points'
        db.delete_column('website_actioncategory', 'points')
    ...
    models = {
        ...
        'website.jurisdictioncontribution': {
            'Meta': {'object_name': 'JurisdictionContribution'},
            'changed_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jurisdiction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['website.Jurisdiction']", 'null': 'True', 'blank': 'True'}),
        ...
        'website.jurisdictioncontributor': {
            ...
            'question_category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['website.QuestionCategory']", 'null': 'True', 'blank': 'True'}),
            'rank': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
