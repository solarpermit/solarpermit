...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuestionCategory.display_order'
        db.add_column('website_questioncategory', 'display_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Question.label'
        db.add_column('website_question', 'label', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'QuestionCategory.display_order'
        db.delete_column('website_questioncategory', 'display_order')

        # Deleting field 'Question.label'
        db.delete_column('website_question', 'label')
