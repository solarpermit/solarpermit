...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserDetail.old_password'
        db.add_column('website_userdetail', 'old_password',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserDetail.old_password'
        db.delete_column('website_userdetail', 'old_password')
