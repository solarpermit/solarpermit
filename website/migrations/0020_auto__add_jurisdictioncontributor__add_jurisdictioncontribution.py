...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JurisdictionContributor'
        db.create_table('website_jurisdictioncontributor', (
            ...
            ('question_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.QuestionCategory'], null=True, blank=True)),
            ...
            ('rank', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('website', ['JurisdictionContributor'])

        # Adding model 'JurisdictionContribution'
        db.create_table('website_jurisdictioncontribution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('jurisdiction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Jurisdiction'], null=True, blank=True)),
            ('question_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.QuestionCategory'], null=True, blank=True)),
            ('changed_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('need_update', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('website', ['JurisdictionContribution'])


    def backwards(self, orm):
        # Deleting model 'JurisdictionContributor'
        db.delete_table('website_jurisdictioncontributor')

        # Deleting model 'JurisdictionContribution'
        db.delete_table('website_jurisdictioncontribution')
