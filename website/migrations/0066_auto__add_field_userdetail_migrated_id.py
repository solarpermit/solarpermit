...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserDetail.migrated_id'
        db.add_column('website_userdetail', 'migrated_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserDetail.migrated_id'
        db.delete_column('website_userdetail', 'migrated_id')
