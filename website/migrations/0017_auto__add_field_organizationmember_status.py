...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationMember.status'
        db.add_column('website_organizationmember', 'status',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=8, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationMember.status'
        db.delete_column('website_organizationmember', 'status')
