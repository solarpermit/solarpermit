...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrganizationMember.join_date'
        db.add_column('website_organizationmember', 'join_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrganizationMember.requested_date'
        db.add_column('website_organizationmember', 'requested_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrganizationMember.join_date'
        db.delete_column('website_organizationmember', 'join_date')

        # Deleting field 'OrganizationMember.requested_date'
        db.delete_column('website_organizationmember', 'requested_date')
