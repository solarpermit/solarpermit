...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EntityView'
        db.create_table('website_entityview', (
        ...
        db.send_create_signal('website', ['EntityView'])

        # Adding model 'EntityViewCount'
        db.create_table('website_entityviewcount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entity_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True)),
            ('entity_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True)),
            ('count', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal('website', ['EntityViewCount'])


    def backwards(self, orm):
        # Adding model 'UniqueEntityView'
        db.create_table('website_uniqueentityview', (
            ('entity_id', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True, null=True, db_index=True)),
            ('entity_name', self.gf('django.db.models.fields.CharField')(blank=True, max_length=32, null=True, db_index=True)),
            ('latest_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('session_key', self.gf('django.db.models.fields.CharField')(blank=True, max_length=40, null=True, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        db.create_table('website_entityviewscount', (
            ('count', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True, null=True, db_index=True)),
            ('entity_id', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True, null=True, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entity_name', self.gf('django.db.models.fields.CharField')(blank=True, max_length=32, null=True, db_index=True)),
        ))
        ...
        # Deleting model 'EntityView'
        db.delete_table('website_entityview')

        # Deleting model 'EntityViewCount'
        db.delete_table('website_entityviewcount')
