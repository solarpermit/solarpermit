...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('website_actiontutorial', (
            ...
            ('action_identifier', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True)),
        ...
        db.create_table('website_usertutorialhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_email', self.gf('django.db.models.fields.EmailField')(db_index=True, max_length=75, null=True, blank=True)),
            ('tutorial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Tutorial'], null=True, blank=True)),
        ...
        db.create_table('website_tutorial', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identifier', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True)),
