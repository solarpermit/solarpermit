...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.display_template'
        db.add_column('website_question', 'display_template',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.field_suffix'
        db.add_column('website_question', 'field_suffix',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.display_template'
        db.delete_column('website_question', 'display_template')

        # Deleting field 'Question.field_suffix'
        db.delete_column('website_question', 'field_suffix')
