...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jurisdiction.last_contributed_by_org'
        db.add_column('website_jurisdiction', 'last_contributed_by_org',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='_org_contributor', null=True, to=orm['website.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jurisdiction.last_contributed_by_org'
        db.delete_column('website_jurisdiction', 'last_contributed_by_org_id')
