...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnswerReference.modify_datetime'
        db.alter_column('website_answerreference', 'modify_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # Changing field 'AnswerReference.modify_datetime'
        db.alter_column('website_answerreference', 'modify_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
