...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('website_userfavorite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('entity_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True)),
            ('entity_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True)),
            ('display_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('website', ['UserFavorite'])

        # Adding field 'Person.phone_mobile'
        db.add_column('website_person', 'phone_mobile',
                      self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'QuestionDependency.answer_choice'
        db.delete_column('website_questiondependency', 'answer_choice_id')

        # Adding field 'UserDetail.notification_preference'
        db.add_column('website_userdetail', 'notification_preference',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('website_userfavorite')

        # Deleting field 'Person.phone_mobile'
        db.delete_column('website_person', 'phone_mobile')

        # Adding field 'QuestionDependency.answer_choice'
        db.add_column('website_questiondependency', 'answer_choice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.AnswerChoice'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserDetail.notification_preference'
        db.delete_column('website_userdetail', 'notification_preference')
