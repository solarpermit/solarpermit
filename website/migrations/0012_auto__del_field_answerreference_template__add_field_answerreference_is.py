...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnswerReference.is_callout'
        db.add_column('website_answerreference', 'is_callout', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AnswerReference.is_callout'
        db.delete_column('website_answerreference', 'is_callout')
