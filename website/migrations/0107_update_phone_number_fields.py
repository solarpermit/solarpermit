...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.fax'
        db.alter_column(u'website_organization', 'fax', self.gf('localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Organization.phone'
        db.alter_column(u'website_organization', 'phone', self.gf('localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Organization.fax'
        db.alter_column(u'website_organization', 'fax', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Organization.phone'
        db.alter_column(u'website_organization', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True))
