...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerReference.status_datetime'
        db.add_column('website_answerreference', 'status_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerReference.status_datetime'
        db.delete_column('website_answerreference', 'status_datetime')
