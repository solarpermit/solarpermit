...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'API_Keys.enabled'
        db.add_column(u'website_api_keys', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'API_Keys.create_datetime'
        db.add_column(u'website_api_keys', 'create_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'API_Keys.revoke_datetime'
        db.add_column(u'website_api_keys', 'revoke_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'API_Keys.enabled'
        db.delete_column(u'website_api_keys', 'enabled')

        # Deleting field 'API_Keys.create_datetime'
        db.delete_column(u'website_api_keys', 'create_datetime')

        # Deleting field 'API_Keys.revoke_datetime'
        db.delete_column(u'website_api_keys', 'revoke_datetime')
    ...
    models = {
        ...
        'website.api_keys': {
            ...
            'revoke_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
