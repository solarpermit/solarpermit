...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("CREATE FUNCTION json_get RETURNS string SONAME 'mysql_json.so'")
        db.execute("CREATE FUNCTION json_valid RETURNS string SONAME 'mysql_json.so'")
        pass

    def backwards(self, orm):
        db.execute("DROP FUNCTION json_get")
        db.execute("DROP FUNCTION json_valid")
        pass
