...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_question', 'question', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Applicability.text'
        db.delete_column('website_applicability', 'text')

        # Adding field 'Applicability.name'
        db.add_column('website_applicability', 'name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Applicability.description'
        db.add_column('website_applicability', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('website_question', 'text', self.gf('django.db.models.fields.CharField')(blank=True, max_length=255, null=True, db_index=True), keep_default=False)

        # Deleting field 'Question.question'
        db.delete_column('website_question', 'question')

        # Adding field 'Applicability.text'
        db.add_column('website_applicability', 'text', self.gf('django.db.models.fields.CharField')(blank=True, max_length=255, null=True, db_index=True), keep_default=False)

        # Deleting field 'Applicability.name'
        db.delete_column('website_applicability', 'name')

        # Deleting field 'Applicability.description'
        db.delete_column('website_applicability', 'description')
