...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'AnswerReference', fields ['is_current']
        db.create_index('website_answerreference', ['is_current'])


    def backwards(self, orm):
        
        # Removing index on 'AnswerReference', fields ['is_current']
        db.delete_index('website_answerreference', ['is_current'])
