...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('website_question', 'qtemplate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Template'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'website.question': {
            ...
            'modify_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'qtemplate': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['website.Template']", 'null': 'True', 'blank': 'True'}),
