...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerReference.organization'
        db.add_column('website_answerreference', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Organization'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Action.organization'
        db.add_column('website_action', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Organization'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerReference.organization'
        db.delete_column('website_answerreference', 'organization_id')

        # Deleting field 'Action.organization'
        db.delete_column('website_action', 'organization_id')
