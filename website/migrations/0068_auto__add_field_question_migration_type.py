...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.migration_type'
        db.add_column('website_question', 'migration_type',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.migration_type'
        db.delete_column('website_question', 'migration_type')
