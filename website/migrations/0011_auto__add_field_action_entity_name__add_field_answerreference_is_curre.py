...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.entity_name'
        db.add_column('website_action', 'entity_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'AnswerReference.is_current'
        db.add_column('website_answerreference', 'is_current', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'AnswerReference.rating'
        db.add_column('website_answerreference', 'rating', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)

        # Deleting field 'Comment.jurisdiction'
        db.delete_column('website_comment', 'jurisdiction_id')

        # Deleting field 'Comment.question'
        db.delete_column('website_comment', 'question_id')

        # Deleting field 'Comment.template'
        db.delete_column('website_comment', 'template_id')

        # Adding field 'Comment.entity_name'
        db.add_column('website_comment', 'entity_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'Comment.entity_id'
        db.add_column('website_comment', 'entity_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.entity_name'
        db.delete_column('website_action', 'entity_name')

        # Deleting field 'AnswerReference.is_current'
        db.delete_column('website_answerreference', 'is_current')

        # Deleting field 'AnswerReference.rating'
        db.delete_column('website_answerreference', 'rating')

        # Adding field 'Comment.jurisdiction'
        db.add_column('website_comment', 'jurisdiction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Jurisdiction'], null=True, blank=True), keep_default=False)

        # Adding field 'Comment.question'
        db.add_column('website_comment', 'question', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['website.Question']), keep_default=False)

        # Adding field 'Comment.template'
        db.add_column('website_comment', 'template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Template'], null=True, blank=True), keep_default=False)

        # Deleting field 'Comment.entity_name'
        db.delete_column('website_comment', 'entity_name')

        # Deleting field 'Comment.entity_id'
        db.delete_column('website_comment', 'entity_id')
