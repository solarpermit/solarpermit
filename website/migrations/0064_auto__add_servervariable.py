...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServerVariable'
        db.create_table('website_servervariable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('value', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('website', ['ServerVariable'])


    def backwards(self, orm):
        # Deleting model 'ServerVariable'
        db.delete_table('website_servervariable')
