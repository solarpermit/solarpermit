...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntityViewCount.count'
        db.delete_column('website_entityviewcount', 'count')

        # Adding field 'EntityViewCount.total_count'
        db.add_column('website_entityviewcount', 'total_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntityViewCount.count_30_days'
        db.add_column('website_entityviewcount', 'count_30_days',
                      self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EntityViewCount.count'
        db.add_column('website_entityviewcount', 'count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'EntityViewCount.total_count'
        db.delete_column('website_entityviewcount', 'total_count')

        # Deleting field 'EntityViewCount.count_30_days'
        db.delete_column('website_entityviewcount', 'count_30_days')
