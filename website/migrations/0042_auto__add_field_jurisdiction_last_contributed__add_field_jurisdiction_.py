...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jurisdiction.last_contributed'
        db.add_column('website_jurisdiction', 'last_contributed',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Jurisdiction.last_contributed_by'
        db.add_column('website_jurisdiction', 'last_contributed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jurisdiction.last_contributed'
        db.delete_column('website_jurisdiction', 'last_contributed')

        # Deleting field 'Jurisdiction.last_contributed_by'
        db.delete_column('website_jurisdiction', 'last_contributed_by_id')
