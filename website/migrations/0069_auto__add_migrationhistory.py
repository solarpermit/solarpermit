...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('website_migrationhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_table', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True)),
            ('source_id', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True)),
            ('target_table', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True)),
        ...
        db.send_create_signal('website', ['MigrationHistory'])


    def backwards(self, orm):
        # Deleting model 'MigrationHistory'
        db.delete_table('website_migrationhistory')
