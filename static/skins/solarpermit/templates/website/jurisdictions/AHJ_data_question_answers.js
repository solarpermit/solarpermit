    ...
    function confirm_rejected(entity_id, value_terminology)
    {
        ...
        $('.add_to_favorites_'+{{this_question.id}}).click(function(event) 
        {   
        ...
        $('.add_to_quirks_'+{{this_question.id}}).click(function(event) 
        {
        ...
        $('.remove_from_favorites_'+{{this_question.id}}).click(function(event) 
        {   
            var $target = $(event.target);
            var questionId = $target.data('id');
            var jid = $target.data('jid');    
        ...
        $('.remove_from_quirks_'+{{this_question.id}}).click(function(event) 
        {
            var $target = $(event.target);
            var questionId = $target.data('id');
            var jid = $target.data('jid');    
