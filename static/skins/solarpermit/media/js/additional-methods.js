...
jQuery.validator.addMethod("domainOrUrl", function(value, element) {
	return this.optional(element) || value.length > 6 &&
		(value.match(/^([a-zA-Z0-9][-a-zA-Z0-9]*[a-zA-Z0-9]\.)+([a-zA-Z0-9]{2,5})$/) ||
...
}, 'Please specify a valid domain name or url.');
