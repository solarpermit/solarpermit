...
(function($) {
    ...
    $.jscroll = {
        defaults: {
            //***solarpermit custom - add callback function
            callback: null,
            debug: false,
            autoTrigger: true,
        ...
        function _load() {
            ...
            return _checkNextHref(data) && $e.animate({scrollTop: $inner.outerHeight()}, 0, function() {
                $inner.find('div.jscroll-added').last().load(data.nextHref, function(r, status, xhr) {
                    ...
                    //***custom - add callback function
                	if ($.isFunction(_options.callback)) {
                		_options.callback.apply();
					}
                    _debug('dir', data);
                });
            });
    ...
    $.fn.jscroll = function(m) {
        return this.each(function() {
            ...
            //***solarpermit custom - always reinitialize so jscroll works after ajax list reload
