...
function template_login()
{
	...
	echo '
		...
		<form action="', $scripturl, '?action=login2" name="frmLogin" id="frmLogin" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? '' : '', '>
	...
	//LSS: Modified below for solarpermit login, removed password hashing
	echo '
				</dl>
				<p><input type="submit" value="', $txt['login'], '" class="button_submit" onclick="$.lsslogin.doLogin(' . "'#frmLogin'" . ');return false;" /></p>
...
function template_kick_guest()
{
	...
	<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/jquery.js"></script>
	<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/sha1.js"></script>
	<form action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin"', empty($context['disable_login_hashing']) ? '' : '', '>
		<div class="tborder login">
			<div class="cat_bar">
...
function template_maintenance()
{
	...
	<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/jquery.js"></script>
<script type="text/javascript" src="', $settings['default_theme_url'], '/scripts/sha1.js"></script>
<form id="frmLoginM" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '"', empty($context['disable_login_hashing']) ? ' ' : '', '>
	<div class="tborder login" id="maintenance_mode">
		...
		<div class="roundframe">
			...
			<p class="centertext"><input type="submit" value="', $txt['login'], '" class="button_submit" onclick="$.lsslogin.doLogin(' . "'#frmLoginM'" . ');return false;" /></p>
		</div>
		<span class="lowerframe"><span></span></span>
		<input type="hidden" name="hash_passwrd" value="" />
	</div>
...
<form action="', $scripturl, $context['get_data'], '" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin" >
	...
	//LSS: modified button, removed password hashing
	echo '
			...
			<input type="submit" style="margin-top:1em;" value="', $txt['login'], '" class="button_submit" onclick="$.lsslogin.doLogin(' . "'#frmLogin'" . ');return false;" />';
